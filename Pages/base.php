...
$conn = mysqli_connect('localhost','root','', 'ad_brokers');

$admemail=$_SESSION['adm_email'];
$sql="select * from admin_table where adm_email='$admemail'";
            ...
            <li class="nav-item dropdown dropdown-user-setting">
              <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;" data-bs-toggle="dropdown">
                <div class="user-setting">
                  <img src="../ProfileImages/<?php echo $result1['adm_image']?>" class="user-img" alt="">
                </div>
              </a>
                ...
                <li>
                  <a class="dropdown-item" href="javascript:;">
                    <div class="d-flex flex-row align-items-center gap-2">
                      <img src="../ProfileImages/<?php echo $result1['adm_image']?>" alt="" class="rounded-circle" width="54" height="54">
                      <div class="">
                        <h6 class="mb-0 dropdown-user-name"><?php echo ucwords($_SESSION['admin_name']) ?></h6>
