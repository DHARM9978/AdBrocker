...
$con = Db_Connection();
$Approved_Order=All_Approved_Order($con);
?>
...
<div class="page-content-wrapper">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            &nbsp;&nbsp;
            &nbsp;&nbsp;
            <div class="breadcrumb-title active pe-3" style="color:#0000FF;border:none;font-size:25px">All Approved Publisher Orders</div>
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="table table-striped data-table" style="width: 100%">
                                        ...
                                        <tbody class="text-center">
                                            <?php
                                    while ($row = $Approved_Order->fetch_assoc()) {
                                    ?>
                                            <tr>
                                                <th scope="row">
