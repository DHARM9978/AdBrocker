...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            &nbsp;&nbsp;
            &nbsp;&nbsp;
            <div class="breadcrumb-title active pe-3" style="color:#0000FF;border:none;font-size:25px">Total Ads</div>
            ...
            <div class="p-2">
                ...
                <div class="my-3 ">
                    <div class="col-md-12 mb-3 w-100">
                        <div class="card">
                            <div class="card-header" style="background-color:#3c096c;margin-top:30px;">
                                <!--background-color: #1F3541;  -->
                                <h4 class="text-center text-white">Advertisements info</h4>
                            </div>
                            <div class="card-body">
